...
ActiveRecord::Schema.define(:version => 20141029023629) do
  ...
  add_index "avatars", ["avatarable_id", "avatarable_type"], :name => "index_avatars_on_avatarable_id_and_avatarable_type"
  ...
  add_index "invitations", ["inviteable_id", "inviteable_type"], :name => "index_invitations_on_inviteable_id_and_inviteable_type"
  add_index "invitations", ["invited_id", "invited_type", "inviteable_id", "inviteable_type"], :name => "fk_one_invite_per_user_per_entity", :unique => true
  add_index "invitations", ["invited_id", "invited_type"], :name => "index_invitations_on_inviter_id_and_inviter_type"
  ...
  add_index "invites", ["inviteable_id", "inviteable_type", "status"], :name => "index_invites_on_inviteable_id_and_inviteable_type_and_status"
  ...
  add_index "localfeeds", ["city"], :name => "index_localfeeds_on_city"
  add_index "localfeeds", ["location_id"], :name => "index_localfeeds_on_location_id"
  ...
  add_index "locations", ["mappable_id", "mappable_type"], :name => "index_locations_on_mappable_id_and_mappable_type"
  ...
  add_index "scribbles", ["scribbled_id", "scribbled_type"], :name => "index_scribbles_on_scribbled_id_and_scribbled_type"
  add_index "scribbles", ["user_id"], :name => "index_scribbles_on_user_id"
  ...
  add_index "skill_fields", ["skill_type_id"], :name => "index_skill_fields_on_skill_type_id"
  ...
  add_index "wards", ["warded_id"], :name => "index_wards_on_warded_id"
