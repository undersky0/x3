...
RSpec.describe BlogCommentsController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all blog_comments as @blog_comments" do
      ...
      expect(assigns(:blog_comments)).to eq([blog_comment])
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created blog_comment" do
        post :create, {:blog_comment => valid_attributes}, valid_session
        expect(response).to redirect_to(BlogComment.last)
      end
    end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested blog_comment" do
        blog_comment = BlogComment.create! valid_attributes
        put :update, {:id => blog_comment.to_param, :blog_comment => new_attributes}, valid_session
        blog_comment.reload
    ...
    describe "with invalid params" do
      it "assigns the blog_comment as @blog_comment" do
        blog_comment = BlogComment.create! valid_attributes
        put :update, {:id => blog_comment.to_param, :blog_comment => invalid_attributes}, valid_session
        expect(assigns(:blog_comment)).to eq(blog_comment)
      end
